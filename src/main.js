...
function renderParams(a) {
    const params = [
        ...
        { label: 'CIN', value: a.sbcin, unit: 'J/kg', max: 300, color: '#3b82f6', desc: 'Convective Inhibition. The amount of "cap" or energy preventing an air parcel from rising. Near-zero means storms form easily.' },
